========================================================================
    APLICACIÓN DE CONSOLA: Console_libpng1 
                           Información general del proyecto
========================================================================

AppWizard ha creado esta aplicación Console_libpng1.

Este archivo incluye un resumen acerca del contenido de los archivos que 
constituyen su aplicación Console_libpng1.


Console_libpng1.vcxproj
...
Console_libpng1.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH) denominado Console_libpng1.pch y un archivo de tipos 
